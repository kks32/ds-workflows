...
Using PyLauncher for tightly coupled workflows. PyLauncher dispatches independent tasks. If tasks need to communicate with each other during execution, use MPI directly instead. [Parallel Computing](parallel-computing.md) covers MPI in detail.
