# Building a Custom Tapis App

This page walks through creating a custom HPC application on [DesignSafe](https://designsafe-ci.org). For background on what Tapis Apps are and how they work, see [Tapis and Custom Apps](../tapis.md).
